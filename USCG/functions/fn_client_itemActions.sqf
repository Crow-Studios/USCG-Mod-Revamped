...
//["USCG_Basket_Item", "Attach Water Basket To Hoist", [1,1,1,1], "", true, true, false, [(vehicle _unit), _unit], "uscg_mod_fnc_deployBasket"] spawn uscg_mod_fnc_client_addItemActions;
