[
"USCG_Basket_Item", // item classname (can be a base class)
"CONTAINER", // type
["Attach Basket To Hoist"], // name
[1,1,1,1], // color RGBA
"", // icon path
[{params ["_unit", "_container", "_item", "_slot", "_params"]; typeOf vehicle _unit in ["vtx_MH60M", "vtx_UH60M_MEDEVAC", "vtx_UH60M_SLICK"]},{params ["_unit", "_container", "_item", "_slot", "_params"]; true}], // condition to use, condition to show
{
    ...
    [vehicle _unit, _unit] call uscg_mod_fnc_deployBasket; // I give up, compile stopped working after the shitty update
    // function here
},
